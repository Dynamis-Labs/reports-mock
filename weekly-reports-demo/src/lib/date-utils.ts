...
/**
 * Formats a date as a short relative time (e.g., "1d", "2w", "3mo")
 * More compact version suitable for tight spaces like sidebars
 */
 ...
 */
export function parseStartTime(date: Date, startTime: string): Date {
...
/**
 * Checks if a meeting is in the past (has already ended)
 */
...
/**
 * Formats a meeting date for display
 * e.g., "Feb 3", "Today", "Tomorrow"
 */
